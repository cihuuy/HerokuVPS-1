...
RUN git clone https://github.com/cihuuy/YouTube-Viewer && cd YouTube-Viewer && python3 -m pip install --upgrade pip wheel && pip3 install "setuptools<59" && pip3 install -r requirements.txt 
